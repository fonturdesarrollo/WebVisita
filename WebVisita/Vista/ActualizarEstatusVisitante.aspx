<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarEstatusVisitante.aspx.cs" Inherits="WebVisita.ActualizarEstatusVisitante" %>
      ...
      <!-- Contenido Aqui -->
          <table>
              <tr class="auto-style2" >
                <td  width="80"  >
                    <asp:Button Text="Actualizar lista" runat="server" ID ="btnActualizar"  CssClass ="boton_formulario" OnClick="btnActualizar_Click" />
                </td>
               </tr>
          </table>
