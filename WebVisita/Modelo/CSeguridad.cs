...
namespace WebVisita.Clases
{
    public class CSeguridad
    {
        ...
        public CSeguridad(int _seguridadUsuarioDatosID, string _loginUsuario, string _claveUsuario, string _nombreCompleto, string _descripcionUsuario, int _seguridadGrupoID, int _usuarioTecnico, string _estatusUsuario, string _nombreGrupo, string _descripcionGrupo, int _seguridadObjetoID, string _nombreObjeto, int _seguridadObjetoAccesoID, int _gerenciaID)
        {
